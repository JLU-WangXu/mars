...
load F:/4-15Marsprotein/mars_stack/inputs/petase_5xh3/5XH3.pdb, target
...
select design_resi, target and chain A and resi 3+40+41+117
select protected_resi, target and chain A and resi 58+103+131+156+174+177+208+210+244+260
select overall_resi, target and chain A and resi 3+40+41+117
select learned_resi, target and chain A and resi 3+40+117
...
pseudoatom title_anchor, pos=[0,0,0], label="petase_5xh3"
...
png F:/4-15Marsprotein/mars_stack/outputs/paper_bundle_v1/structure_panels/petase_5xh3/overview.png, width=2400, height=1800, dpi=300, ray=1
...
png F:/4-15Marsprotein/mars_stack/outputs/paper_bundle_v1/structure_panels/petase_5xh3/design_window.png, width=2400, height=1800, dpi=300, ray=1

save F:/4-15Marsprotein/mars_stack/outputs/paper_bundle_v1/structure_panels/petase_5xh3/figure_session.pse
quit
