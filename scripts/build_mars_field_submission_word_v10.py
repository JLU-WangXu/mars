...
OUT = ROOT / "outputs" / "paper_bundle_v1" / "MARS_FIELD_Submission_Style_v10.docx"
...
def main() -> None:
    ...
    add_p(doc, "Submission-style draft v10", size=10.2, align=WD_ALIGN_PARAGRAPH.CENTER)

    add_h(doc, "Article Spine", 1)
    emit_markdown(doc, CLAIMS)

    add_h(doc, "Main Figures", 1)
    add_figure(doc, "figure1_mars_field_architecture_v3.png", "Figure 1 | MARS-FIELD integrates heterogeneous evidence into a shared residue field.", width=6.05)
    ...
    add_figure(doc, "figure4_case_studies_master_v5.png", "Figure 4 | PSE-derived case-study composite.", width=6.05)
