...
OUT = ROOT / "outputs" / "paper_bundle_v1" / "MARS_FIELD_Submission_Style_v7.docx"
FIG = ROOT / "outputs" / "paper_bundle_v1" / "figures"

INTRO_DISC = ROOT / "docs" / "mars_field_intro_discussion_draft_v1.md"
METHODS = ROOT / "docs" / "mars_field_methods_full_v1.md"
LEGENDS = ROOT / "docs" / "mars_field_figure_legends_v1.md"
RELATED = ROOT / "docs" / "mars_field_related_work_full_v1.md"
...
def main() -> None:
    ...
    add_p(doc, "Submission-style draft v7", size=10.5, align=WD_ALIGN_PARAGRAPH.CENTER)

    add_h(doc, "Main Figures", 1)
    add_figure(doc, "figure1_mars_field_architecture_v2.png", "Figure 1 | MARS-FIELD integrates heterogeneous evidence into a shared residue field.", width=6.15)
    add_figure(doc, "figure2_benchmark_claim_v5.png", "Figure 2 | Benchmark claim figure.", width=6.15)
    add_figure(doc, "figure3_mechanism_limitations_v5.png", "Figure 3 | Mechanism and limitation figure.", width=6.15)
    add_figure(doc, "figure4_case_studies_master_v3.png", "Figure 4 | PSE-derived case-study composite.", width=6.15)
